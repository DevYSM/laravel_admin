...
if (!function_exists('getSection')) {
    ...
    {
        return \App\Models\Section::where('id',$id)->first();
    }
}
...
if (!function_exists('getConfig')) {
    ...
    {
        return \App\Models\config::where('id',$id)->first();
    }
}
...
if (!function_exists('getSidebarLinks')) {
    ...
    {
        return [
            ['name' => 'sliders', 'icon' => '<i class="fas fa-sliders-h text-warning"></i>'],
            ['name' => 'services', 'icon' => '<i class="fas fa-user-cog text-warning"></i>'],
            ['name' => 'products', 'icon' => '<i class="fab fa-product-hunt text-warning"></i>'],
            ['name' => 'projects', 'icon' => '<i class="fab fa-r-project text-warning"></i>'],
            ['name' => 'pages', 'icon' => '<i class="fas fa-pager text-warning"></i>'],
            ['name' => 'sections', 'icon' => '<i class="fas fa-folder-plus text-warning"></i>'],
            ['name' => 'configs', 'icon' => '<i class="fas fa-cogs text-warning"></i>'],
        ];
    }
}
