...
@section('content')
    <div class="container-fluid ">
        ...
        <form autocomplete="off" method="POST" action="{{ route('sliders.update', $slider) }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                <!-- .col-md-6 -->
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                               ...
                                               data-default-file="{{ $slider->photo() }}" />
                                        @error('photo')
                                        <small class="form-text text-danger font-weight-bold">
                                            {{ $message }}
                                        </small>
                                                ...
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group @error($key.'.body') has-danger @enderror">
                                                        ...
                                                        <textarea class="ckeditor form-control form-control-alternative @error($key.'.body') is-invalid @enderror"
                                                            ...
                                                            rows="6"
                                                            >{{ optional($slider->translate($key))->body != null ? optional($slider->translate($key))->body : old($key.'.body') }}</textarea>
                                                        @error('body')
