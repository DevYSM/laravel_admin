...
@section('content')
     <div class="container-fluid ">
        ...
        @endif
        <form autocomplete="off" method="POST" action="{{ route('projects.update', $project) }}"  enctype="multipart/form-data" >
            @csrf
            @method('PATCH')
            <div class="row">
                <!-- .col-md-6 -->
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                               ...
                                               data-default-file="{{ $project->photo() }}" />
                                        @error('photo')
                                        <small class="form-text text-danger font-weight-bold">
                                            {{ $message }}
                                        </small>
                                                ...
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group @error($key.'.title') has-danger @enderror">
                                                        ...
                                                        <input
                                                            ...
                                                            autofocus
                                                            value="{{ optional($project->translate($key))->title }}"
                                                ...
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group @error($key.'.body') has-danger @enderror">
                                                        ...
                                                        <textarea class="ckeditor form-control form-control-alternative @error($key.'.body') is-invalid @enderror"
                                                                  ...
                                                                  @if($loop->first) required @endif
                                                                  rows="6"
                                                        >{{ optional($project->translate($key))->body != null ? optional($project->translate($key))->body : old($key.'.body') }}</textarea>
                                                        @error($key.'.body')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
