...
@section('content')
    <div class="container-fluid ">
        ...
        <form autocomplete="off" method="POST" action="{{ route('services.update', $service) }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                <!-- .col-md-6 -->
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <div class="form-group">
                                        <label for="author">Service Name</label>
                                        <input type="text"
                                               name="author"
                                               class="form-control"
                                               id="author"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                               ...
                                               data-default-file="{{ $service->photo() }}" />
                                        @error('photo')
                                        <small class="form-text text-danger font-weight-bold">
                                            {{ $message }}
                                        </small>
                                                ...
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group @error($key.'.title') has-danger @enderror">
                                                        ...
                                                        <input
                                                            ...
                                                            autofocus
                                                            value="{{ optional($service->translate($key))->title != null ? optional($service->translate($key))->title : old($key.'.title') }}"
                                                ...
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group @error($key.'.body') has-danger @enderror">
                                                        ...
                                                        <textarea class="ckeditor form-control form-control-alternative @error($key.'.body') is-invalid @enderror"
                                                                  ...
                                                                  @if($loop->first) required @endif
                                                            rows="6"
                                                            >{{ optional($service->translate($key))->body != null ? optional($service->translate($key))->body : old($key.'.body') }}</textarea>
                                                        @error('body')
